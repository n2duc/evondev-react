    ...
    return (
        <div className='p-5 bg-white shadow-md flex items-center justify-center'>
            { user ? <div className="flex items-center gap-x-3">
                ...
                <span className='text-sm font-medium'>Welcom back! <strong>{user.fullname}</strong></span>
            </div>
